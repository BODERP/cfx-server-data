	...
	while true do
		...
		if not servico then
			...
			if distance <= 100.0 then
				DrawMarker(21,locs[selecionado].x,locs[selecionado].y,locs[selecionado].z-0.3,0,0,0,0,180.0,130.0,0.6,0.8,0.5,250,100,50,250,1,0,0,1)
				if distance <= 1.2 and IsControlJustPressed(0,38) and not IsPedInAnyVehicle(ped) and emP.checkWeight() and GetEntityModel(vehicle) == 48339065 then
					...
					TriggerEvent("progress",13000,"Extraindo Minério")
