...
local garages = { 
	[1] = { locked = false, camera = { x =-207.75, y = -1321.61, z = 30.89, heading = 337.98 }, driveout = { x = -210.56, y = -1315.42, z = 30.54, heading = 180.18 }, drivein = { x = -210.56, y = -1315.42, z = 30.54, heading = 180.18 }, outside = { x = -210.56, y = -1315.42, z = 30.54, heading = 180.18 }, inside = { x = -210.56, y = -1315.42, z = 30.54, heading = 180.18 }},
	[2] = { locked = false, camera = { x = -227.79, y = -1330.52, z = 30.89, heading = 286.87 }, driveout = { x = -222.95, y = -1328.99, z = 30.54, heading = 90.37 }, drivein = { x = -222.95, y = -1328.99, z = 30.54, heading = 90.37 }, outside = { x = -222.95, y = -1328.99, z = 30.54, heading = 90.37 }, inside = { x = -222.95, y = -1328.99, z = 30.54, heading = 90.37 }},
	--[3] = { locked = false, camera = { x = -324.3, y = -134.07, z = 39.0, heading = 30.87 }, driveout = { x = -324.3, y = -134.07, z = 39.0, heading = 30.37 }, drivein = { x = -324.3, y = -134.07, z = 39.0, heading = 30.37 }, outside = { x = -324.3, y = -134.07, z = 39.0, heading = 30.37 }, inside = { x = -324.3, y = -134.07, z = 39.0, heading = 30.37 }},
	[3] = { locked = false, camera = { x = -181.31, y = -1286.1, z = 31.57, heading = 270.77 }, driveout = { x = -181.31, y = -1286.1, z = 31.57, heading = 270.77 }, drivein = { x = -181.31, y = -1286.1, z =31.57, heading = 270.77 }, outside = { x = -181.31, y = -1286.1, z =31.57, heading = 270.77 }, inside = { x = -181.31, y = -1286.1, z =31.57, heading = 270.77 }},
	[4] = { locked = false, camera = { x = -1156.68, y = -2020.0, z = 12.48, heading = 65.85 }, driveout = { x = -1156.68, y = -2020.0, z = 12.48, heading = 225.64 }, drivein = { x = -1156.68, y = -2020.0, z = 12.48, heading = 225.64 }, outside = { x = -1156.68, y = -2020.0, z = 12.48, heading = 225.64 }, inside = { x = -1156.68, y = -2020.0, z = 12.48, heading = 225.64 }}, -- LS SUL AEROPORTO
	[5] = { locked = false, camera = { x = -1165.81, y = -2012.03, z = 12.56, heading = 340.34 }, driveout = { x = -1165.81, y = -2012.03, z = 12.56, heading = 135.09 }, drivein = { x = -1165.81, y = -2012.03, z = 12.56, heading = 135.09 }, outside = { x = -1165.81, y = -2012.03, z = 12.56, heading = 135.09 }, inside = { x = -1165.81, y = -2012.03, z = 12.56, heading = 135.09 }}, -- LS SUL AEROPORTO
	--[3] = { locked = false, camera = { x = -1163.56, y = -1693.21, z = 4.45, heading = 326.79 }, driveout = { x = -1160.21, y = -1688.53, z = 3.93, heading = 123.86 }, drivein = { x = -1160.21, y = -1688.53, z = 3.93, heading = 123.86 }, outside = { x = -1160.21, y = -1688.53, z = 3.93, heading = 123.86 }, inside = { x = -1160.21, y = -1688.53, z = 3.93, heading = 123.86 }},
	--[8] = { locked = false, camera = { x = -227.28, y = -1327.96, z = 30.89, heading = 89.70 }, driveout = { x = -222.50, y = -1329.67, z = 30.89, heading = 89.70 }, drivein = { x = -222.50, y = -1329.67, z = 30.89, heading = 89.70 }, outside = { x = -222.50, y = -1329.67, z = 30.89, heading = 89.70 }, inside = { x = -222.50, y = -1329.67, z = 30.89, heading = 89.70 }},
...
function CanPurchase(price,canpurchase)
	if canpurchase then
		if LSCMenu.currentmenu == "main" then
			...
			TriggerEvent("Notify","sucesso","Modificação aplicada por <b>R$" ..parseInt(price).. " reais</b>",8000)
