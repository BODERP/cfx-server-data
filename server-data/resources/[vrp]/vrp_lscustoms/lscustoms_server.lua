...
function emP.checkPermission()
	...
	if user_id then
		return vRP.hasPermission(user_id,"mecanico.permissao") or vRP.hasPermission(user_id, "admin.permissao") or vRP.hasPermission(user_id, "none.permissao") or vRP.hasPermission(user_id, "desmanche.permissao")  --(vRP.hasPermission(user_id,"mecanico.permissao") or vRP.hasPermission(user_id,"bennys.permissao"))
	end
end
