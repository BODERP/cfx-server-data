...
local chest = {
	...
	["Coronel"]   = { 5000,"policia.permissao"   },
	["Mare"]      = { 5000,"mare.permissao"      },
	["Rocinha"]   = { 8000,"helipa.permissao"   }, -- baú da Helipa chama-se Rocinha
	["Motoclub"]   = { 5000,"motoclub.permissao"   }, 
	["Vidigal"]   = { 5000,"vidigal.permissao"   },
	["Italianos"] = { 5000,"milicia.permissao" 	 },
	["Desmanche"] = { 5000,"desmanche.permissao" },
	["Chefe"] = { 5000,"chefe.permissao" }, -- permissão temporária para baú do desmanche pelos chefes da mecânica
	["Mecanico"]  = { 5000,"mecanico.permissao"  },
	["Yakuza"]    = { 5000,"yakuza.permissao"    },
	--["Advocacia"] = { 5000,"advogado.permissao"  },
	["bdel"]      = { 5000,"del.permissao" 		 },
	["bpg"]       = { 5000,"pcivil.permissao" 	 },
	["Vanilla"]       = { 5000,"vanilla.permissao" 	 },
	--["Prefeitura"]       = { 5000,"admin.permissao" 	 },
	["TaxistasLavagem"]       = { 5000,"lavagem.permissao" 	 },
	["Zeronze"]       = { 5000,"zeronze.permissao" 	 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIÁVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
