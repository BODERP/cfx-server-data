...
local css = [[
	...
	#DocumentSection .each-info.person-job {
		border-top: 1px solid rgba(200,0,200, 0.8);
		border-bottom: 1px solid rgba(200,0,200, 0.8);
		margin: 25px auto;
		padding: 10px 0;
		color: #f2f1ef;
		font-size: 18px;
		...
		if IsControlJustPressed(0,344) then
			...
			if identity then
				...
				if foto == nil or foto == "" then
					foto  = "https://cdn.discordapp.com/attachments/848415190747971584/855871293291495454/goat-rp-loading.png"
				end
			...
			if identity then
				...
				if foto == nil or foto == "" then
					foto  = "https://i.imgur.com/UCKk6Xo.png"
				end
				local html = string.format("<div id='DocumentSection'><div class='avatar-img'><img src='%s'></div> <div class='infos'><div class='main-info'>"..
					"<h1 class='each-info person-name'>%s %s</h1>"..
					"<h2 class='each-info person-age'>%s anos</h2>"..
