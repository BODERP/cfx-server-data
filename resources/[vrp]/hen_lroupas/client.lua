...
local lojaderoupa = {
    ...
    --{ name = "Loja de Roupas", id = 73, color = 13, x = -1192.86, y = -768.47, z = 17.32, provador = {x = -1192.86, y = -768.47, z = 17.32, heading = 0.0}},
    --{ name = "Loja de Roupas", id = 73, color = 13, x = 455.84, y = -989.67, z = 30.69, provador = {x = 455.84, y = -989.67, z = 30.69, heading = 0.0}},
    ...
    --{ name = "Loja de Roupas", id = 73, color = 13, x = 1196.41, y = 2709.21, z = 38.23, provador = {x = 1196.41, y = 2709.21, z = 38.23, heading = 0.0}},
    --{ name = "Loja de Roupas", id = 73, color = 13, x =  -1100.86, y = 2710.29, z = 19.11, provador = {x = -1100.86, y = 2710.29, z = 19.11, heading = 0.0}},
    --{ name = "Loja de Roupas", id = 73, color = 13, x =  -3171.39, y = 1043.74, z = 20.87, provador = {x = -3171.39, y = 1043.74, z = 20.87, heading = 0.0}},
    --{ name = "Loja de Roupas", id = 73, color = 13, x =  1693.2, y = 4822.42, z = 42.07, provador = {x = 1693.2, y = 4822.42, z = 42.07, heading = 0.0}},
    { name = "Loja de Roupas", id = 73, color = 13, x =  1371.63, y = -104.72, z = 124.79, provador = {x = 1371.63, y = -104.72, z = 124.79, heading = 0.0}},
    --{ name = "Loja de Roupas", id = 73, color = 13, x =  454.6, y = -990.98, z = 30.69, provador = {x =  454.6, y = -990.98, z= 30.69, heading = 0.0}},
    
    --{ name = "Loja de Roupas", id = 73, color = 13, x = 337.21, y = -579.29, z = 43.31, provador = {x = 337.21, y = -579.29, z = 43.31, heading = 154.50}},
    --{ name = "Loja de Roupas", id = 73, color = 13, x = -1095.32, y = -831.49, z = 14.29, provador = {x = -1095.32, y = -831.49, z = 14.29, heading = 154.50}},
}
